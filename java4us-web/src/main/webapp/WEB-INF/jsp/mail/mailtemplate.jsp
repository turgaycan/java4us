...
.wrapper .btn a {
    ...
    color: #000 !important;
    outline-color: #29cc41;
    text-shadow: 0 1px 0 #3ed154
}

.wrapper .btn a:hover {
    background-color: #3ed154 !important;
    color: #000 !important;
    outline-color: #3ed154 !important
}

.preheader .title, .preheader .webversion, .footer
.padded {
    color: #999
}
...
<table class="border"
    ...
    <tr style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least;font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif">
        <td class="logo" style="font-size: 20px;">
            <div><label>${fullname}</label> <label style="float: right; padding-right: 5px;">${date}</label></div>
        </td>
    </tr>
</table>
                                ...
                                <tr>
                                    <td class="padded"
                                        ...
                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 21px;line-height: 32px;Margin-bottom: 32px;text-align: left">
                                            <strong style="font-weight: bold"><a href="#">${feedMessage}</a></strong>
                                        </p>
                          ...
                          <span class="block">
                            <span>
                              ...
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                            ...
                                            <span class="block">
                                                <a style="font-weight: bold;text-decoration: none;transition: all .2s;color: #999"
                                                   href="${rootUrl}/unsubscriber-${subscriberId}">Unsubscribe</a></span>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
