...
<div class="account-container">
    ...
    <div class="content clearfix">
        ...
        <form action="<c:url value='/feeders/j_spring_security_check' />"
              method='POST'>
            ...
            <div class="login-fields">
                ...
                <div class="field">
                    <label for="j_password">Password:</label> <input type="password"
                                                                     id="j_password" name="j_password" value=""
            ...
            <div class="login-actions">
					...
					<span class="login-checkbox"> <input id="Field" name="Field"
                                                         type="checkbox" class="field login-checkbox"
                                                         value="First Choice"
                ...
                <button class="button btn btn-success btn-large" name="submit"
                        type="submit" value="submit">Sign In
                </button>
...
<div class="login-extra">
    <a href="${java4usRoot}/feeders/resetpassword">Reset Password</a>
</div>
<!-- /login-extra -->
